...
Dans le cadre de ce rapport, l'IA a été utilisée uniquement comme une aide à la rédaction. Le modèle utilisé est ChatGPT.

L'ensemble des concepts et des idées présentés dans ce rapport ont été développés \textbf{sans l'aide de l'IA}.
