...
L'ensemble est généralement intégré dans une boucle de régulation de type \ac{pid} afin d'assurer un contrôle précis de la vitesse et/ou de la position.
...
\paragraph{\ac{foc}}
La commande \ac{foc} repose sur la décomposition du courant moteur en deux composantes orthogonales via les transformations de Clarke et Park.
