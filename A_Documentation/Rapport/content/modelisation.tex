...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{assets/figures/graphs/acceleration_misalign_com.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{assets/figures/graphs/velocity_misalign_com.pdf}
    \caption{Vitesse}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{assets/figures/graphs/position_misalign_com.pdf}
    \caption{Position}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{assets/figures/graphs/reg_P_acccel.pdf}
    \caption{Accélération du système avec uniquement le gain proportionnel $K_{pt}$.}
    \label{fig:reg_P_accel}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{assets/figures/graphs/reg_P_velocity.pdf}
    \caption{Vitesse du système avec uniquement le gain proportionnel $K_{pt}$.}
    \label{fig:reg_P_velocity}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{assets/figures/graphs/reg_P_angles.pdf}
    \caption{Angle du système avec uniquement le gain proportionnel $K_{pt}$.}
    \label{fig:reg_P_angle}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{assets/figures/graphs/reg_PD_acccel.pdf}
    \caption{Accélération du système après ajout de l'action dérivée ($K_{pt}$, $T_{dt}$).}
    \label{fig:reg_PD_accel}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{assets/figures/graphs/reg_PD_velocity.pdf}
    \caption{Vitesse du système après ajout de l'action dérivée ($K_{pt}$, $T_{dt}$).}
    \label{fig:reg_PD_velocity}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{assets/figures/graphs/reg_PD_angles.pdf}
    \caption{Angle du système après ajout de l'action dérivée ($K_{pt}$, $T_{dt}$).}
    \label{fig:reg_PD_angle}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{assets/figures/graphs/reg_ALL_acccel.pdf}
    \caption{Accélération du système avec les deux boucles de régulation synthétisées.}
    \label{fig:reg_ALL_accel}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{assets/figures/graphs/reg_ALL_velocity.pdf}
    \caption{Vitesse du système avec les deux boucles de régulation synthétisées.}
    \label{fig:reg_ALL_velocity}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{assets/figures/graphs/reg_ALL_angles.pdf}
    \caption{Angle du système avec les deux boucles de régulation synthétisées.}
    \label{fig:reg_ALL_angle}
\end{figure}
