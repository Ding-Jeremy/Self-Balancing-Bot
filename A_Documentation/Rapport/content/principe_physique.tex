...
\end{equation}
Le signe positif devant le terme en $\theta$ implique que toute perturbation s'amplifie avec le temps. Le système admet un unique point d'équilibre en $\theta = 0$. Cependant, la moindre perturbation éloigne le système de cette position, les écarts augmentant au cours du temps. En pratique, il est donc impossible de maintenir cet équilibre, ce qui rend le système instable.
