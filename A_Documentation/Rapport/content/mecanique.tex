...
Une fois le principe physique expliqué, il est temps de réaliser la maquette. Le but ici est de tenir compte des réflexions faites durant la partie théorique.
...
L'ensemble des dessins mécaniques se trouve à l'annexe \ref{annexe:dessins_mecaniques}. De plus, les fichiers 3D des pièces sont également disponibles sur le dépôt Git indiqué en annexe \ref{annexe:git}.
...
Dans les équations précédentes, la distance $l$ représente la distance entre l'axe de rotation des roues et le centre de gravité du châssis. 
...
\hline
1 & Protection anti-chute & $0.010$ & 0.010 & \si{\kilogram} \\
\hline
2 & Protection anti-chute & $0.010$ & 0.010 & \si{\kilogram} \\
\hline
3 & Protection anti-chute & $0.010$ & 0.010 & \si{\kilogram} \\
\hline
4 & Protection anti-chute & $0.010$ & 0.010 & \si{\kilogram} \\
\hline
5 & Protection anti-chute & $0.010$ & 0.010 & \si{\kilogram} \\
\hline
...
L'analyse du modèle CAO réalisée sous Fusion 360 permet de déterminer avec précision la position de l'\acrshort{imu} par rapport à l'axe de rotation des roues. Cette information est nécessaire afin de tenir compte des accélérations linéaires mesurées par le capteur lors des mouvements du robot.
