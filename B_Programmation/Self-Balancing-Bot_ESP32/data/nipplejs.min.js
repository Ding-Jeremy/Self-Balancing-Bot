      ...
      (E.prototype = new T()),
        ...
        (E.prototype.createNipple = function (t, i) {
          ...
          if (t.x && t.y)
            ...
            n.zone.removeChild(s),
              (o = t),
              (t = { x: r.left + e.x, y: r.top + e.y });
          }
          var d = new P(this, {
            color: n.color,
            size: n.size,
          ...
          return (
            n.dataOnly || (u(d.ui.el, o), u(d.ui.front, d.frontPosition)),
            this.nipples.push(d),
            ...
            if (
              ("circle" === o.options.shape
                ? ((m = Math.min(w, p)),
                  ...
                  (O = { x: 0, y: 0 }),
                  (x = s((x = _))),
                  (O.x = g.x - b * Math.cos(x)),
                  (O.y = g.y - b * Math.sin(x)),
                  (v = O))
                : ((v = (function (t, i, e) {
                    return {
